      ...
      if (restaurantResponse.ok && restaurantData.restaurant) {
        ...
        if (restaurantData.restaurant.assignedDeliveryPartners?.length > 0) {
          const partnersResponse = await fetch(
            '/api/restaurant/delivery-partners'
          );
      ...
      <div className="animate-fade-in space-y-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your night-time delivery orders and menu
          </p>
        </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-orange-700">
                    Your restaurant is available for orders from 9:00 PM to
                    12:00 AM
                  </p>
                </div>
              </div>
