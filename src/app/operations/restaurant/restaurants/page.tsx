          ...
          <Card key={restaurant.id} className="restaurant-card">
            <CardContent className="p-6">
              ...
              <div className="space-y-2">
                <div className="flex gap-2">
                  <Link href={`/operations/restaurant/restaurants/${restaurant.id}`} className="flex-1">
                ...
                <Link href={`/operations/restaurant/restaurants/${restaurant.id}/menu`} className="block">
                  <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white text-sm touchable">
