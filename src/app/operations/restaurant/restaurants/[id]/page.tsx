    ...
    try {
      ...
      if (menuData.success) {
        ...
        setStats({
          ...
          activeMenuItems: menuItems.filter((item: any) => item.available)
            .length,
          featuredMenuItems: menuItems.filter((item: any) => item.featured)
            .length,
        ...
        <div className="space-y-6">
          <div className="py-12 text-center">
            ...
            <Link href="/operations/restaurant/restaurants">
              <Button className="bg-accent-leaf-green hover:bg-accent-leaf-green/90 text-primary-dark-green touchable mt-4">
                Back to Restaurants
              </Button>
            </Link>
          </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Link
              href={`/operations/restaurant/restaurants/${restaurantId}/menu`}
            >
              <Button className="bg-[#ffd500] font-semibold text-[#002a01] hover:bg-[#ffd500]/90">
        ...
        <Card className="border-0 bg-white/70 shadow-lg backdrop-blur-sm">
          <CardHeader>
            <div className="flex items-start justify-between">
              <div>
                <CardTitle className="flex items-center gap-3 text-2xl font-bold text-[#002a01]">
              ...
              <Badge
                className={`border px-3 py-2 text-sm font-medium ${getStatusBadgeColor(restaurant.status)}`}
              >
                {restaurant.status}
              </Badge>
            </div>
          ...
          <CardContent>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center text-gray-600">
                      <Star className="mr-3 h-5 w-5 fill-yellow-400 text-yellow-400" />
            ...
            {/* Cuisine Types */}
            <div className="mt-6">
              <h3 className="mb-3 text-lg font-semibold text-[#002a01]">
                Cuisine Types
              </h3>
              <div className="flex flex-wrap gap-2">
                {restaurant.cuisineTypes.map((cuisine) => (
                  <Badge
                    key={cuisine}
                    className="bg-accent-leaf-green text-primary-dark-green px-3 py-1"
                  >
                    {cuisine}
                  </Badge>
                ))}
            ...
            <Card className="restaurant-card">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  <Menu className="text-primary-dark-green h-8 w-8" />
                </div>
              </CardContent>
            </Card>
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-blue-600">
                      {stats.totalMenuItems > 0
                        ? Math.round(
                            (stats.activeMenuItems / stats.totalMenuItems) * 100
                          )
                        : 0}
                      %
                    </p>
        ...
        <Card className="restaurant-card">
          <CardHeader>
            <CardTitle className="text-lg font-semibold text-[#002a01]">
              Quick Actions
            </CardTitle>
            <CardDescription>
          ...
          <CardContent>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
              <Link
                href={`/operations/restaurant/restaurants/${restaurantId}/menu`}
              >
                <Button className="bg-accent-leaf-green hover:bg-accent-leaf-green/90 text-primary-dark-green touchable w-full">
                  <Menu className="mr-2 h-4 w-4" />
                  Manage Menu
                </Button>
              </Link>

              <Button className="touchable w-full bg-blue-600 text-white hover:bg-blue-700">
                <Users className="mr-2 h-4 w-4" />
                View Orders
              </Button>

              <Button className="touchable w-full bg-purple-600 text-white hover:bg-purple-700">
              ...
              <Button
                ...
                className="touchable w-full bg-gray-600 text-white hover:bg-gray-700"
              >
