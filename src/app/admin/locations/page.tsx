...
const LocationForm: React.FC<LocationFormProps> = ({ 
  ...
  <div className="space-y-4">
    ...
    <div className="flex justify-end space-x-2 pt-4">
      ...
      <Button
        onClick={onSubmit}
        disabled={isSubmitting || !formData.name || !formData.city || !formData.state || !formData.country}
          ...
          <div className="flex items-center space-x-3">
            ...
            <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
              <DialogTrigger asChild>
                <Button className="bg-[#d1f86a] hover:bg-[#d1f86a]/90 text-[#002a01] font-semibold">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#002a01]">{locations.length}</p>
                </div>
                <MapPin className="w-8 h-8 text-[#d1f86a]" />
              </div>
            </CardContent>
          </Card>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#002a01]">
                    {locations.reduce((sum, loc) => sum + loc.restaurantCount, 0)}
                  </p>
                </div>
                <Building2 className="w-8 h-8 text-[#ffd500]" />
              </div>
            </CardContent>
          </Card>
        </div>
              ...
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                  ...
                  <Badge 
                    ...
                    className={location.isActive ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}
                  >
                    {location.isActive ? (
                      <>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="flex items-center">
                    <Building2 className="w-4 h-4 mr-1 text-[#d1f86a]" />
                    <span className="font-medium">{location.restaurantCount}</span>
                  </div>
                </div>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            ...
                            This action will hide the location from restaurant onboarding.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                ...
                {location.restaurantCount > 0 && (
                  <p className="text-xs text-gray-500 bg-gray-50 p-2 rounded">
                    Cannot delete: {location.restaurantCount} restaurant(s) are using this location
                  </p>
                )}
              </CardContent>
            </Card>
