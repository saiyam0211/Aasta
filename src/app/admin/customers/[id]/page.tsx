      ...
      <AdminLayout>
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center space-y-4">
            <div className="w-16 h-16 bg-[#d1f86a] rounded-full flex items-center justify-center mx-auto animate-pulse">
              <User className="w-8 h-8 text-[#002a01]" />
            </div>
            <h3 className="text-lg font-semibold text-[#002a01]">Loading customer details...</h3>
          </div>
        </div>
      </AdminLayout>
    );
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        ...
        <p className="text-sm">Average Order Value: ₹{customer.stats.averageOrderValue.toFixed(2)}</p>
      ...
      <Card>
        ...
        {customer.stats.favoriteRestaurants.length === 0 ? (
          ...
          customer.stats.favoriteRestaurants.map((restaurant: any, index: number) => (
      ...
      <Card>
        ...
        {customer.stats.addressUsage.map((address: any, index: number) => (
          <div key={index} className="mb-2">
            ...
            <p className="text-sm text-gray-500">Orders to this address: {address.orderCount}</p>
          </div>
        ))}
      </Card>
    </div>
