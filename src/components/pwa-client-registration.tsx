...
export default function PWAClientRegistration({ pageIdentifier }: PWAClientRegistrationProps) {
    ...
    const registerPWAClient = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.error(`❌ ${pageIdentifier} PWA Client registration failed:`, {
        ...
        console.error(`❌ ${pageIdentifier} PWA Client registration error:`, error);
      }
    };
