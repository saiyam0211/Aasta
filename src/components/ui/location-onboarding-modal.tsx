...
export function LocationOnboardingModal({ isModal = false, onClose }: LocationOnboardingModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex min-h-screen w-full items-center justify-center bg-black/50 backdrop-blur-md">
      <div className="mx-4 w-full max-w-md rounded-3xl bg-[#d3fb6b] p-6 shadow-2xl">
        {/* Header */}
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-2xl font-bold text-black">Select Location</h1>
          <button
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <button
              ...
              className="w-full rounded-2xl border-2 border-gray-300 bg-white px-4 py-3 text-left text-black focus:border-[#002a01] focus:outline-none"
            >
            ...
            {isDropdownOpen && (
              <div className="absolute z-10 mt-2 w-full rounded-2xl border border-gray-200 bg-white shadow-lg max-h-48 overflow-y-auto">
                {locations.length > 0 ? (
        ...
        <button
          ...
          className="w-full rounded-2xl bg-[#dcf874] py-4 text-lg font-semibold text-black shadow-md active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed"
        >
