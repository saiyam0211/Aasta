...
// Import API handlers
import {
  GET as adminRestaurantsGET,
  POST as adminRestaurantsPOST,
} from '../../app/api/admin/restaurants/route';
...
import {
  GET as deliveryPartnersGET,
  POST as deliveryPartnersPOST,
} from '../../app/api/delivery-partners/route';
import {
  GET as ordersGET,
  POST as ordersPOST,
...
describe('API Integration Tests', () => {
  ...
  describe('/api/delivery-partners', () => {
    it('should retrieve delivery partners (GET)', async () => {
      const request = new NextRequest(
        'http://localhost:3000/api/delivery-partners',
        {
          method: 'GET',
        }
      );
